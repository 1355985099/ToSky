                       ...
                       <form method="post" role="form" name="form1" action="${pageContext.request.contextPath}/findOrderByOrderInfoId">
                           ...
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input type="text" class="form-control" id="orderInfoId" name="orderInfoId" placeholder="请输如快递订单号" >
                           ...
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input type="text" class="form-control" id="receiveTel" name="receiveTel" placeholder="请输入您要查询的手机号" >
                                   <span class="input-group-btn">
